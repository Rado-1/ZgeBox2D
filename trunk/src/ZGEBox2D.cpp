...
#define PI2 6.2831853071796865f
...
export b2Body* zb2CreateBox(float x, float y, float width, float height, float angle, int type) {
	b2BodyDef bodyDef;
	bodyDef.type = (b2BodyType)type;
